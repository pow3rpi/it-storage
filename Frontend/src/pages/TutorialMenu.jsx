...
export default function TutorialMenu() {
  ...
  const loadNextPage = async () => {
    setIsLoading(true);
    const params = { type: SearchType.tutorial, page: searchFilter.page };
  ...
  useEffect(() => {
    ...
    setPosts([]);
    setIsMore(false);
    const params = { type: SearchType.tutorial };
  ...
  return (
    <div className='container'>
      ...
      <div className='row'>
        <h2 className='col-12 text-center mb-5 mt-lg-5'>Manage Tutorials</h2>
      </div>
